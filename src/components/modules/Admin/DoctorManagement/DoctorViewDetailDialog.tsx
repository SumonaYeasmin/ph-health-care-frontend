...
import { formatDateTime, getInitials } from "@/src/lib/formatters";
...
// Local component to render information row
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-lg mb-6">
            <div className="relative h-24 w-24 border-4 border-white shadow-lg rounded-full overflow-hidden bg-muted flex items-center justify-center font-bold text-2xl text-muted-foreground shrink-0">
              {doctor.profilePhoto ? (
                <Image
